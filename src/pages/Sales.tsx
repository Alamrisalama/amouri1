...
const INPUT_SM = 'w-full bg-white border border-slate-200 rounded-lg py-1.5 px-2 text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:border-[#a97a1f] transition-all';
                ...
                <div className="col-span-2 flex flex-col gap-1.5">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <select value={form.manual_status} onChange={e => setForm(p => ({ ...p, manual_status: e.target.value }))}
                      className="border border-slate-200 rounded-xl py-2 px-3 text-xs text-slate-600 focus:outline-none focus:border-gold-400 bg-white">
